...
!function (t, e) {
  ...
  class Z extends H {
    ...
    static dataApiClickHandler(t) {
      ...
      const n = {...F.getDataAttributes(e), ...F.getDataAttributes(this)}, s = this.getAttribute("data-bs-slide-to");
    ...
    name: "arrow", enabled: !0, phase: "main", fn: function (t) {
      ...
      if (o && r) {
        var h = function (t, e) {
          ...
          g = Ct(o), _ = g ? "y" === l ? g.clientHeight || 0 : g.clientWidth || 0 : 0, b = p / 2 - m / 2, v = h[u],
  ...
  function Zt(t, e) {
    ...
    var i = e, n = i.placement, s = void 0 === n ? t.placement : n, o = i.boundary,
      ...
      p = void 0 === f ? 0 : f, m = Nt("number" != typeof p ? p : It(p, rt)),
  ...
  function Jt(t, e) {
    ...
    var i = e, n = i.placement, s = i.boundary, o = i.rootBoundary, r = i.padding, a = i.flipVariations,
      l = i.allowedAutoPlacements, c = void 0 === l ? lt : l, h = Qt(n), d = h ? a ? at : at.filter((function (t) {
        return Qt(t) === h
    ...
    name: "flip", enabled: !0, phase: "main", fn: function (t) {
      ...
      if (!e.modifiersData[n]._skip) {
        for (var s = i.mainAxis, o = void 0 === s || s, r = i.altAxis, a = void 0 === r || r, l = i.fallbackPlacements, c = i.padding, h = i.boundary, d = i.rootBoundary, u = i.altBoundary, f = i.flipVariations, p = void 0 === f || f, m = i.allowedAutoPlacements, g = e.options.placement, _ = gt(g), b = l || (_ !== g && p ? function (t) {
          ...
          var C = v[O], k = gt(C), L = "start" === Qt(C), x = [it, nt].indexOf(k) >= 0, D = x ? "width" : "height",
  ...
  var ne = {
    ...
    name: "preventOverflow", enabled: !0, phase: "main", fn: function (t) {
      var e = t.state, i = t.options, n = t.name, s = i.mainAxis, o = void 0 === s || s, r = i.altAxis,
        ...
        g = Zt(e, {boundary: l, rootBoundary: c, padding: d, altBoundary: h}), _ = gt(e.placement), b = Qt(e.placement),
        v = !b, y = kt(_), w = "x" === y ? "y" : "x", E = e.modifiersData.popperOffsets, A = e.rects.reference,
      ...
      if (E) {
        if (o || a) {
          var k = "y" === y ? it : ot, L = "y" === y ? nt : st, x = "y" === y ? "height" : "width", D = E[y],
            ...
            j = "start" === b ? -T[x] : -A[x], M = e.elements.arrow, H = f && M ? vt(M) : {width: 0, height: 0},
  ...
  class ii extends H {
    ...
    refresh() {
      const t = this._scrollElement === this._scrollElement.window ? "offset" : "position",
        i = "auto" === this._config.method ? t : this._config.method, n = "position" === i ? this._getScrollTop() : 0;
